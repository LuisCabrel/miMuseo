...
public class SelectorDeMedia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adaptadorBusquedas(this,cuadros,imagenes,urls,false);
...
/*
                        ...
                        adaptadorBusquedas(getApplicationContext(),cF,iF,uF,false);
                        adaptadorCuadros.notifyDataSetChanged();
                        */
                        reaccionAnteBusqueda(query);
        ...
        MenuItemCompat.setOnActionExpandListener(searchItem,
                new MenuItemCompat.OnActionExpandListener(){
                    ...
                    public boolean onMenuItemActionExpand(MenuItem menuItem) {
                        ...
                        adaptadorBusquedas(getApplicationContext(),cuadros,imagenes,urls,false);
                        adaptadorCuadros.notifyDataSetChanged();
    ...
    public void reaccionAnteBusqueda(String query){
        int j;
        Vector<String> cF, iF, uF;
        cF=new Vector<String>();
        iF=new Vector<String>();
            ...
            public void onClick(View v) {
                ...
                if((!c.isEmpty())   ){
                    ...
                    if(!((c.size()==1)&&soporte.contains("Sin cuadros"))){
                        String mediaCuadro, mediaImagen, tituloCuadro;
                        int pos=recyclerView.getChildAdapterPosition(v);

                        try{
                            mediaCuadro=u.get(pos);
                            mediaImagen=i.get(pos);
                            tituloCuadro=c.get(pos);
                            Intent intent=new Intent(SelectorDeMedia.this,PlayerActivity.class);
                            intent.putExtra("cuadro",mediaCuadro);
                            intent.putExtra("imagen",mediaImagen);
                            intent.putExtra("titulo",tituloCuadro);

                            ActivityOptionsCompat options = ActivityOptionsCompat.makeSceneTransitionAnimation(
                                    SelectorDeMedia.this,
                                    new Pair<View, String>(v.findViewById(R.id.imgVwCuadroAdapt), getString(R.string.transition_cuadro)));
                            ActivityCompat.startActivity(SelectorDeMedia.this, intent, options.toBundle());

                        }catch (Exception e){
                            Toast.makeText(SelectorDeMedia.this, "Sin cuadros", Toast.LENGTH_SHORT).show();
                        }
                    }else{
                        Toast.makeText(context, "No se ha cargado aún las obras", Toast.LENGTH_SHORT).show();
                    }
    ...
    public void leerCuadros(){
        ...
        if(cursor.getCount()==0){
            Toast.makeText(SelectorDeMedia.this,"Sin cuadros",Toast.LENGTH_LONG).show();
